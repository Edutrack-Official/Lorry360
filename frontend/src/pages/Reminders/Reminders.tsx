...
//                         <button
//                           key={status}
//                           onClick={() => setFilterStatus(status as "all" | "pending" | "done")}
//                           className={`px-3 py-1.5 rounded-lg text-xs font-medium capitalize transition-colors ${
//                             filterStatus === status
//                               ? status === "all" ? 'bg-blue-600 text-white'
//                                 : status === "pending" ? 'bg-purple-600 text-white'
...
//     if (filterStatus !== "all") {
//       filtered = filtered.filter(reminder => {
//         // Consider reminder as done if either done flag is true OR whatsapp was sent
//         const isDone = reminder.done || reminder.whatsappSent;
...
//                           {/* Date Badge */}
//                           <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs bg-gray-100 text-gray-700 border border-gray-200">
//                             <Calendar className="h-3 w-3" />
//                             {formatDate(reminder.date)}
//                           </div>
...
//                             <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs bg-green-50 text-green-700 border border-green-200">
...
//                         {/* WhatsApp Sent Timestamp */}
//                         {reminder.whatsappSent && reminder.whatsappSentAt && (
//                           <p className="text-xs text-green-600 mt-2 flex items-center gap-1 font-medium">
//                             <Send className="h-3 w-3" />
//                             Notification sent on {formatDateTime(reminder.whatsappSentAt)}
//                           </p>
//                         )}
//                       </div>
//                     </div>
...
//               const isDone = reminder.done || reminder.whatsappSent;
//               const isPending = !isDone;
//               const isLocked = reminder.done || reminder.whatsappSent; // 🔒 Locked
...
//                             🔒 This reminder is locked and cannot be edited or deleted
//                           </p>
//                         )}
...
//                       {/* Mark as Done Button - Only show if not locked */}
//                       {!isLocked && (
//                         <button
//                           onClick={(e) => {
//                             e.stopPropagation();
...
//                           }}
//                           className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all text-xs font-medium active:scale-95"
//                         >
