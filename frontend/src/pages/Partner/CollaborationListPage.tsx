            ...
            <div className="flex items-start gap-3">
              ...
              {type === 'received' ? (
                <button
                  ...
                  className="flex items-center justify-center gap-1 px-3 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-xs font-medium flex-shrink-0"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1 px-3 py-1.5 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-xs font-medium flex-shrink-0"
                >
