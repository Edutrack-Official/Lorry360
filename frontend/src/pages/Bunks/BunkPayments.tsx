    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b z-20 shadow-sm">
        <div className="px-4 py-4 sm:px-6">
          <div className="flex items-center justify-between gap-3 mb-3">
            ...
            <Link
              to={`/bunks/${bunkId}/payments/create`} // Changed route
      ...
      <div className="px-4 py-3 sm:px-6 bg-white border-b">
        <div className="flex items-center gap-2">
          ...
          {(searchText || filterPaymentMode !== "all" || dateRange.start || dateRange.end) && (
            <button
        ...
        {showActionMenu && (
          <>
            ...
            >
              <button
                onClick={() => {
                  navigate(`/bunks/${bunkId}/payments/edit/${showActionMenu}`); // Changed route
                  setShowActionMenu(null);
                }}
